...
export default function Contact() {
    ...
    return (
        <section id="contact" className="py-24 px-6 max-w-4xl mx-auto w-full relative">
            ...
            {/* Render the Toast UI anywhere in the component (it is fixed to the screen) */}
            <ToastComponent />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                >
                    <div>
                        ...
                        <a href="mailto:wdjayeshpal@gmail.com" className="flex items-center gap-3 text-muted hover:text-accent transition-colors">
