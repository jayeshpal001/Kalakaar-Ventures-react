                ...
                >
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="p-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-full hover:bg-white/10 hover:scale-110 hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all text-foreground">
